<?php
// $Id: advanced_forum.minimal.forums.tpl.php,v 1.1.2.1 2010/06/29 21:12:48 eigentor Exp $
...
<?php if ($forums_defined): ?>
  <div id="forum" class="<?php print $language_class; ?>">
    ...
    <?php if (!empty($topics)): ?>
      ...
      <div class="forum-primary-links"><?php print $forum_links ?><?php print $forum_secondary_links ?></div>
    <?php endif; ?>
