<?php
// $Id: advanced_forum.minimal.forum-list.tpl.php,v 1.1.2.1 2010/06/29 20:27:51 eigentor Exp $
    ...
    <table id="container-<?php print $container_number; ?>" class="forum-table">
      <thead class="forum-header">
        <tr>
          ...
          <th class="forum-name"><a href="<?php print $forum->link; ?>"><?php print $forum->name; ?><span class="container-description"><?php print $forum->description; ?></span></a></th>
