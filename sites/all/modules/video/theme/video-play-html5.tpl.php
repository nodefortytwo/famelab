<?php
//$Id: video-play-html5.tpl.php,v 1.1.2.5 2010/12/03 11:59:46 heshanmw Exp $
/*
 * @file
...
?>
  ...
  <video width="<?php echo $video->player_width; ?>" height="<?php echo $video->player_height; ?>" controls="controls" preload="auto" poster="<?php echo $video->thumbnail->url; ?>">
    <?php //dd($items); ?>
